...
module.exports = ( function ($) {
  ...
  $.cookieBar = function (options,val) {
    ...
    user_state_detected = j1.core.existsCookie (user_state_cookie_name);
    if ( user_state_detected ) {
      logger.info('User state cookie found');
  //  user_state = j1.getUserState();
      user_state = j1.core.readCookie(user_state_cookie_name);
    } else {
