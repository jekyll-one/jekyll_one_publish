...
index:                                  []
categories:                             [ tutorial, kickstarter ]
...
resource_options:
  ...
  - attic:
      opacity:                          0.5
      slides:
        - url:                          /assets/images/attics/banner/docker-1280x600-bw.jpg
...
// [role="mb-3"]
// image::/assets/images/blog/series/j1_using_docker/windows_docker_banner.1280x500.png[{{page.title}}]
