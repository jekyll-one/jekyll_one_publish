...
resource_options:
  - attic:
      ...
      opacity:                          0.5 
      slides:
        - url:                          /assets/images/blog/wikipedia/columbia-river.1200x400.jpg
          alt:                          Columbia River
---
...
[role="mb-3"]
image::/assets/images/blog/wikipedia/columbia-river.1200x400.jpg[{{page.title}}]
