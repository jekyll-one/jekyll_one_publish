...
tags:                                   [ Wikipedia ]
index:                                  [ USA, Minnesota, City, Minneapolis ]
categories:                             []
...
resource_options:
  - attic:
      ...
      opacity:                          0.5 
      slides:
        - url:                          /assets/images/blog/wikipedia/minneapolis.1200x400.jpg
          alt:                          Minnesota
---
...
[role="mb-3"]
image::/assets/images/blog/wikipedia/minneapolis.1200x400.jpg[{{page.title}}]
