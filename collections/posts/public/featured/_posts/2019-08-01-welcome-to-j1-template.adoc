...
series:
adsense:                                false
image:                                  /assets/images/attics/welcome-1920x1280-bw.jpg

tags:                                   [ Example, Post ]
index:                                  [ Website, Static, Site, Difference CMS ]
categories:                             []
...
resource_options:
  - attic:
      ...
      opacity:                          0.5
      slides:
        - url:                          /assets/images/attics/welcome-1920x1280-bw.jpg
...
// image::/assets/images/attics/spider-web-1920x1200-bw.png[{{page.title}}, 800]
