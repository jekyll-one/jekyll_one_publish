    ...
    init: function (options) {
      ...
      logger.info('module is being initialized');
          ...
          if ($('#owl_demo_text_carousel').length) {
              logText = 'Slider on ID owl_demo_text_carousel being initialized';
              logger.info(logText);
          ...
          if ($('#owl_demo_text_carousel_parallax').length) {
              logText = 'Slider on ID owl_demo_text_carousel_parallax being initialized';
              logger.info(logText);
              _this.setState('running');
              logger.info('state: ' + _this.getState());
              logger.info('module is being initialized');
          ...
          if ($('#owl_demo_cats').length) {
              logText = 'Slider on ID owl_demo_cats being initialized';
              logger.info(logText);
              _this.setState('running');
              logger.info('state: ' + _this.getState());
              logger.info('module is being initialized');
          ...
          if ($('#owl_demo_simple').length) {
              logText = 'Slider on ID owl_demo_simple being initialized';
              logger.info(logText);
              _this.setState('running');
              logger.info('state: ' + _this.getState());
              logger.info('module is being initialized');
          ...
          if ($('#owl_demo_oneslide').length) {
              logText = 'Slider on ID owl_demo_oneslide being initialized';
              logger.info(logText);
              _this.setState('running');
              logger.info('state: ' + _this.getState());
              logger.info('module is being initialized');
